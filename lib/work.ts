...
export const workCollections: WorkCollection[] = [
  ...
  },
  {
    ...
    description:
      "A brand shoot for Naples Jet Center, the full-service FBO and maintenance base in Naples, Florida. Hangar and flight-line studies at the reflection hour, MRO and engine work in the shop, chef-built catering and branded touches, and the arrivals that move through it, cut for the brand and the social feed.",
    href: "/work/naples-jet-center",
    video: {
      vimeoId: "1223486283",
      title: "Naples Jet Center — brand film",
    },
    socialCuts: [
      { vimeoId: "835545009", title: "Naples Jet Center — social cut" },
    ],
    verticalImages: [
      {
        src: "/images/work/naples-jet-center/naples-jet-center-v01.jpg",
        alt: "Guests boarding a jet up the airstairs at Naples Jet Center, vertical",
        width: 1200,
        height: 1800,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-v02.jpg",
        alt: "Exposed engine internals during maintenance at Naples Jet Center, vertical",
        width: 1200,
        height: 1800,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-v03.jpg",
        alt: "Naples Jet Center branded welcome box, vertical",
        width: 1200,
        height: 1800,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-v04.jpg",
        alt: "Remove-before-flight streamer on the landing gear, vertical",
        width: 1200,
        height: 1800,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-v05.jpg",
        alt: "Naples Jet Center building exterior with a Ford Bronco under the palms, vertical",
        width: 1200,
        height: 1800,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-v06.jpg",
        alt: "American flag on the hangar wall at Naples Jet Center, vertical",
        width: 1200,
        height: 1800,
      },
    ],
    images: [
      {
        src: "/images/work/naples-jet-center/naples-jet-center-01.jpg",
        alt: "Private jet on the ramp mirrored on the wet apron outside the hangar",
        width: 2000,
        height: 1333,
        cover: true,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-02.jpg",
        alt: "Jet silhouette reflected in the hangar mouth at Naples Jet Center",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-03.jpg",
        alt: "Clients arriving to a jet on the ramp beside a Bentley Bentayga",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-04.jpg",
        alt: "Private jet on the flight line beside a luxury sports car",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-05.jpg",
        alt: "Technician working on an open engine cowling in the hangar",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-06.jpg",
        alt: "Jet raised on jacks in the maintenance shop with technicians at work",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-07.jpg",
        alt: "Detail of a jet engine turbine during service",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-08.jpg",
        alt: "Chef-built charcuterie board plated for a Naples Jet Center flight",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-09.jpg",
        alt: "Jet cabin seat set with champagne and a catering board",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-10.jpg",
        alt: "Jet framed in the open hangar door with a crew member alongside",
        width: 2000,
        height: 1333,
      },
      {
        src: "/images/work/naples-jet-center/naples-jet-center-11.jpg",
        alt: "Jets on the Naples Jet Center ramp with a Ford Bronco",
        width: 2000,
        height: 1333,
      },
    ],
  ...
  },
  {
    ...
    location: "Tampa, Florida",
    description:
      "A listing package for a Pilatus PC-24, shot for 5x5 Trading on the ramp in Tampa. Bright blue-sky exterior airframe studies and a white-and-blue leather cabin with the flight deck, cut for brokerage decks, listing sites, and the social feed.",
    href: "/work/pilatus-pc24",
    socialCuts: [
      { vimeoId: "1223738780", title: "Pilatus PC-24 — social cut" },
    ],
    images: [
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-01.jpg",
        alt: "Three-quarter view of the Pilatus PC-24 on the ramp under a bright sky",
        width: 2000,
        height: 1334,
        cover: true,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-02.jpg",
        alt: "Side profile of the Pilatus PC-24 on the ramp against a blue sky",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-03.jpg",
        alt: "Rear three-quarter view of the Pilatus PC-24 on the ramp",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-04.jpg",
        alt: "Pilatus PC-24 on the ramp in Tampa",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-05.jpg",
        alt: "Engine and tail detail of the Pilatus PC-24 against a blue sky",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-06.jpg",
        alt: "Glass flight deck of the Pilatus PC-24",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-07.jpg",
        alt: "White-and-blue leather cabin of the Pilatus PC-24 looking forward",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-08.jpg",
        alt: "Pilatus PC-24 cabin with club seating and a folding table",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-09.jpg",
        alt: "Forward view of the Pilatus PC-24 cabin and table",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-10.jpg",
        alt: "Club seats in white and blue leather aboard the Pilatus PC-24",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-11.jpg",
        alt: "Armrest, cupholder, and seat controls detail in the Pilatus PC-24",
        width: 2000,
        height: 1334,
      },
      {
        src: "/images/work/pilatus-pc24/pilatus-pc24-12.jpg",
        alt: "Pilatus PC-24 flight deck and cabin entry",
        width: 2000,
        height: 1334,
      },
    ],
